export type Screen = 'splash' | 'main-menu' | 'settings' | 'scorekeeper' | 'database' | 'stats' | 'ecosystem' | 'my-profile' | 'people-directory' | 'team-directory' | 'team-profile' | 'roster-builder' | 'free-agency' | 'calendar' | 'event-planner' | 'teamstore' | 'lineup-builder' | 'draft-mode' | 'setup-wizard' | 'scores' | 'standings' | 'rulebook' | 'more' | 'players' | 'my-team';
